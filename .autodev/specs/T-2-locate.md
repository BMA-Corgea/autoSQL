...
| 7 | **`ANSWERS-FROM-EVAN.md`, `QUESTIONS-FOR-EVAN.md`, `WRAPUP-FOR-EVAN.md`** | They are the record of what he said. `ANSWERS-FROM-EVAN.md`'s "Still outstanding" list is known to be stale (§7.1's operation-9 ruling says so) and is still **not this ticket's to edit** | code review |
